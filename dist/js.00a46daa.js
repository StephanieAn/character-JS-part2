...
// Fetch API :
var fecthChar = /*#__PURE__*/function () {
...
_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var characters, newBtn, bar, searchName;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _fetch.fecthChar)();
        ...
        case 2:
          ...
          characters.forEach(function (character) {
            ...
            clone.querySelector("img").src = "data:image/png;base64,".concat(character.image);
            clone.querySelector("p").innerHTML = character.shortDescription;
            clone.querySelector("h3").innerHTML = character.name;
            clone.querySelector("a").href = "./pages/manager-character.html?".concat(character.id);
            target.appendChild(clone);
          }); // Switch to the Single Character page   

          newBtn = document.getElementById('index-new-btn');
          newBtn.addEventListener("click", function () {
            window.location.href = "./pages/manager-character.html";
          }); //SEARCH BAR

          bar = document.getElementById('search-bar'); // let i = '47'

          searchName = characters[name];
          console.log(searchName);
          bar.addEventListener('input', function () {
            var searchstring = bar.value.toUpperCase();
          });
...
//     };
// });
},{"./fetch.js":"js/fetch.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
